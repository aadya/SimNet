...
class Activity::RealTimeManager :public Fwk::PtrInterface<Activity::RealTimeManager> {
...
public:
	...
	//virtual void lastActivityIs(Activity::Ptr);

	//virtual Time Now(){return clock_};
	virtual void NowIs(Time) = 0;
...
extern Fwk::Ptr<Activity::RealTimeManager> realTimeActivityManagerInstance();
